 ...
 * Doydoy
 *
 * @brief	Décorateur pour les labels
 *        Permet de modifier l'id du décorateur Label
 *
 * @category   Doydoy
 * @package    Doydoy/Form
 ...
 */
class  Doydoy_Form_Decorator_Label extends Zend_Form_Decorator_Abstract
{
    /**
     * Placement constants
     */
    ...
    /**
     * id du décorateur Label
     * @var string
     */
    protected  $_id_label_deco;
    ...
    /**
    * Récupération de l'id de décorateur 'Label'
    *
    * If none set in decorator, looks first for element 'id' attribute, and
    * defaults to element name. Et ajout de '-label'
    *
    * @return string
    */
    public function getLabelId()
    {
        $id = $this->_id_label_deco;
        if (null === $id) {
            if (null !== ($element = $this->getElement())) {
    ...
    /**
     * Assignation de l'id de décorateur 'Label'
     *
     * @param  string $id
     * @return Zend_Form_Decorator_Label
     */
    public function setLabelId($id_label)
    {
        $this->_id_label_deco = $id_label; 
